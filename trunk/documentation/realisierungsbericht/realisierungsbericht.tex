...
\bibliography{realisierungsbericht}{}
\flushleft
\newpage
\tableofcontents
\newpage
...
\begin{figure}[h!]
\includegraphics[scale=0.50]{class2.png}
\caption{Klassendiagramm}
\end{figure}
\newpage
\begin{landscape}
\begin{figure}[h!]
\includegraphics[scale=0.9]{sequence.png}
...
\section{Sourcecode}
\subsection{Main.py}
\lstinputlisting{../../experimental/Main.py}
\subsection{DB.py}
\lstinputlisting{../../experimental/DB.py}
\subsection{Utility.py}
\lstinputlisting{../../experimental/Utility.py}
\subsection{CLI.py}
\lstinputlisting{../../experimental/CLI.py}
\subsection{TagManager.py}
\lstinputlisting{../../experimental/TagManager.py}
\subsection{FileManager.py}
\lstinputlisting{../../experimental/FileManager.py}
\subsection{FileSystemListener.py}
\lstinputlisting{../../experimental/FileSystemListener.py}
\subsection{FileSystemListener Linux.py}
\lstinputlisting{../../experimental/FileSystemListener_Linux.py}
\subsection{FileSystemListener Windows.py}
\lstinputlisting{../../experimental/FileSystemListener_Windows.py}
\subsection{FileSystemListener Mac.py}
\lstinputlisting{../../experimental/FileSystemListener_Mac.py}
\subsection{GUI.py}
\lstinputlisting{../../experimental/GUI.py}
\subsection{TagView.py}
\lstinputlisting{../../experimental/TagView.py}
\subsection{HirarchicalView.py}
\lstinputlisting{../../experimental/HirarchicalView.py}
\subsection{View.py}
\lstinputlisting{../../experimental/View.py}
\subsection{File.py}
\lstinputlisting{../../experimental/File.py}
\subsection{FileProperties.py}
\lstinputlisting{../../experimental/FileProperties.py}
\subsection{gui.glade}
\lstinputlisting{../../experimental/gui.glade}
\subsection{fileproperties.glade}
\lstinputlisting{../../experimental/fileproperties.glade}
\end{document}
